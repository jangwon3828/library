...
public class BookWriteService {
    ...
    public void getNewBookInfo(){
        String bookName = InputView.inputString("책 제목을 입력해 주세요.");
        String author = InputView.inputString("저자명을 입력해 주세요.");
        String publisher = InputView.inputString("출판사를 입력해 주세요.");
        Long borrowCount = InputView.inputLong("해당 책의 누적 대출 횟수를 입력해 주세요.");
        String ISBN_NO = InputView.inputString("해당 책의 ISBN_NO 값을 입력해 주세요.");
        LocalDate year_of_publication = InputView.inputLocalDateTime("책 출간년도를 입력해 주세요. (format : yyyy-MM-dd)");
